            ...
            <div class="w-64 bg-white shadow-lg">
                ...
                <nav class="mt-6">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center px-6 py-3 bg-blue-100 text-blue-700 border-r-3 border-blue-700">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-50">
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
