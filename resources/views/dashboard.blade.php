            ...
            <div class="w-64 bg-white shadow-lg">
                <div class="p-6">
                    <div class="flex items-center space-x-2">
                        ...
                        <div>
                            <h2 class="font-bold text-gray-800">Project Name</h2>
                ...
                <nav class="mt-6">
                    <a href="#" class="flex items-center px-6 py-3 bg-blue-100 text-blue-700 border-r-3 border-blue-700">
                    ...
                    <a href="#" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-50 relative">
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"></path>
                        </svg>
                        Penjual
                        <span class="absolute right-4 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">1</span>
                    </a>
