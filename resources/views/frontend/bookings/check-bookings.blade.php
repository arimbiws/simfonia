        ...
        <div class="text-center mb-12">
            ...
            {{-- <div class="max-w-lg mx-auto">
                <div class="relative">
                    ...
                    <input type="text" placeholder="Type / NIK / ID Number"
                        class="w-full pl-10 pr-4 py-3 border-gray-800 text-white placeholder-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
            </div> --}}
        </div>
